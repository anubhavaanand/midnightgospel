 ...
 * Creates sense of existential dread and ego dissolution.
 * 
 * Design Principles:
 * - Skeletal forms (twisted bones, skulls)
 * - Organic yet horrific (living death)
 * - Color palette: Purple base (#2E004F), bone white (#F0F0F0), rim lighting accent
 * - Subtle animation suggests movement/suffering
 * - Non-Euclidean geometry hints (twisted perspective)
 * 
 * Visual Metaphor:
 * - Souls crawling from earth = struggling with mortality
 * - Twisted geometry = mental distortion/ego death
 * - Skeletal forms = naked truth (bones beneath flesh)
 * - Matches "Annihilation of Joy" episode theme
 */
...
export default function SkeletalLandscape() {
  ...
  return (
    <group ref={landscapeRef} position={[0, -3, -8]}>
      ...
      {/* Rim light accent - highlights skeletal forms */}
      <mesh position={[0, 2, 3]} scale={[15, 1, 1]} castShadow>
