...
const ZombieCapitol: React.FC = () => {
  ...
  return (
    <group>
      ...
      {/* The Central Entity (Glasses Man placeholder) */}
      <mesh position={[0, 0, 0]} onClick={(e) => { e.stopPropagation(); console.log("Clicked Glasses Man"); }}>
      ...
      <mesh>
        ...
        <zombieShaderMaterial ref={materialRef} side={THREE.BackSide} />
      </mesh>
