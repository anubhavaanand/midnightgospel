...
const MeditationCave: React.FC = () => {
  ...
  return (
    <group>
      ...
      <mesh position={[0, 0, 0]} onClick={(e) => { e.stopPropagation(); openDialogue(6); }} onPointerOver={() => document.body.style.cursor = 'pointer'} onPointerOut={() => document.body.style.cursor = 'auto'}>
      ...
      <mesh>
        ...
        {/* @ts-ignore */}
        <meditationCaveShaderMaterial ref={materialRef} side={THREE.BackSide} />
      </mesh>
